...
### Install
```{r install package, results= FALSE}
...
.footnote[picture credit: [Wikimedia of Hadley Wickham](https://www.redarmy.in/)]
...
* Markdownis a lightweight markup language for creating formatted text using a plain-text editor.<sup>*</sup>
--
